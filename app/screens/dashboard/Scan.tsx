...
export default function Scan() {
 ...
 return (
  <View style={{ width: '100%', backgroundColor: bgColor, flex: 1 }}>
   <DefaultHeader />
   {/* <ScrollView contentContainerStyle={styles.scrollViewContent} keyboardShouldPersistTaps="handled"> */}
   <ThemedView transparent style={styles.container}>
    <ThemedText style={styles.title} family='medium' size={24}>Scan</ThemedText>
    ...
    <ThemedView noPadding style={[styles.formRow, { marginVertical: 30 }]} transparent>
     <ThemedButton activeOpacity={0.6} containerStyle={{ width: '45%' }} style={styles.cancel} textStyle={{ color: Colors.light.green800 }} size={12} title='Clear' handleClick={handleClear} />
     <ThemedButton activeOpacity={0.6} containerStyle={{ width: '45%' }} title='Search' size={12} handleClick={handleSearch} />
    </ThemedView>

    <ActivityLogs filter={filter} showTab={false} tabs={['Scan']} />
